...
public class Build {
	...
	static {
		...
		if (urlStr.startsWith("file:/")
				&& (urlStr.endsWith(esPrefix + ".jar") || urlStr.endsWith(esPrefix + "-SNAPSHOT.jar"))) {
			...
			// not running from the official elasticsearch jar file (unit tests, IDE, uber
			// client jar, shadiness)
			shortHash = "Unknown";
			date = "Unknown";
			...
			if (buildSnapshot != null) {
				try {
					...
					throw new IllegalStateException(
							"build.snapshot set to [" + buildSnapshot + "] but not running tests");
				}
